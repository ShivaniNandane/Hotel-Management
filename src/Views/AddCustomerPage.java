...
//room no
        ...
        roomLabel.setFont(DEFAULT_FONT);
        constraints.gridx = 0;
        constraints.gridy = gridy;
        addCustomerPanel.add(roomLabel, constraints);

        JTextField roomField = new JTextField(20);
        roomField.setFont(DEFAULT_FONT);
        constraints.gridx = 1;
        addCustomerPanel.add(roomField, constraints);
...
// Check-Out Date
        ...
        gridy++;
        String[] columnNames = {"Customer Name", "Email", "Phone Number", "Address", "Aadhaar ID", "PAN ID", "Check-In", "Check-Out", "Is Group","Room No","Action"};
        DefaultTableModel tableModel = new DefaultTableModel(columnNames, 0);

        // Sample rows (replace with actual data)
        tableModel.addRow(new Object[]{"John Doe", "john@example.com", "1234567890", "123 Main St", "111122223333", "ABCDE1234F", "01/10/2024", "05/10/2024", "No", "101","Edit"});
        tableModel.addRow(new Object[]{"Jane Smith", "jane@example.com", "9876543210", "456 Elm St", "222233334444", "XYZ98765P", "02/10/2024", "06/10/2024", "Yes", "102","Edit"});
...
//            String roomNo = roomField.getText().trim();
        ...
        customersTable.getColumnModel().getColumn(10).setCellEditor(new CustomerPageAction(new JTextField()));
    }
