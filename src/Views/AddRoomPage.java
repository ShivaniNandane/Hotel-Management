...
public class AddRoomPage {
    ...
    public AddRoomPage() {
        ...
        String[] columnNames = {"Room Type", "Room Number", "Price", "Size", "Features","Status","RoomDetails"};
 
        tableModel = new DefaultTableModel(columnNames, 0);
        tableModel.addRow(new Object[]{"Deluxe", "101", "$200", "350", "Sea View, WiFi","Available","Edits"});
 
        tableModel.addRow(new Object[]{"Suite", "102", "$350", "500", "Private Pool, WiFi, TV","Booked","Edits"});
        tableModel.addRow(new Object[]{"Suite", "102", "$350", "500", "Private Pool, WiFi, TV","Work","Edits"});
        ...
        submitButton.addActionListener(e -> {
            ...
            tableModel.addRow(new Object[]{roomType, roomNumber, "$" + pricePerNight, roomSize, additionalFeatures,"Edits"});
        ...
        roomsTable.getColumnModel().getColumn(6).setCellEditor(new RoomPageEdit(new JTextField()));
    }
